...
@section ('content')
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>  {{-- // TODO: Check if jquery it has been added already or update jQuery reference --}}
